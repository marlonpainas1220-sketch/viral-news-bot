const Soberano = {
    ...
    async sync() {
        ...
        } catch (e) { f.innerHTML = "<p style='text-align:center; padding:50px;'>ERRO DE SINAL. RECARREGUE.</p>"; }
    },
    play() {
        const cmd = JSON.parse(localStorage.getItem('vitrin_v3_cmd'));
        ...
        if(cmd && cmd.marca) intro = `Este sinal chega a você por ${cmd.marca}, ${cmd.frase}. Manchete: `;
